...
<table class="container-lsdh" border="2">
        <thead>
            ...
            <th class="thead-item">ID</th>
                ...
                <th class="thead-item">Ngày Đặt Hàng</th>
                <th class="thead-item">Thao Tác</th>
            </tr>
        </thead>
        <tbody>
    ...
    foreach($lsdh as $ls): 
        ...
        if ($product) : ?>
            ...
            <td class="tbody-items"><?= $ls['id']?></td>
                ...
                <td class="tbody-items"><a href="index.php?act=order_detail&id=<?=$ls['order_id']?>">Xem</a></td>
            </tr>
        <?php 
        else : ?>
            <tr>
                <td colspan="7">Không tìm thấy thông tin sản phẩm cho ID: <?= $product_id ?></td>
            </tr>
        <?php
        endif;
    endforeach;
} else {
    echo '<tr><td colspan="7">Bạn chưa mua hàng.</td></tr>';
}
?>
        </tbody>
    </table>